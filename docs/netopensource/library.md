...
所有的项目库大多数推荐的链接地址为NuGet包的地址，建议直接在 NuGet 或相应的官方网站上搜索最新的包和正确的文档信息
...
- 官方 NuGet 包: [MiniExcel](https://www.nuget.org/packages/MiniExcel)
...
- GitHub 页面: [iTextSharp](https://github.com/itext/itext7-dotnet)
...
- 官方 NuGet 包: [QuestPDF](https://www.nuget.org/packages/QuestPDF)
...
### ZXing.Net
开源的多格式 1D/2D 条码图像处理库。
https://www.nuget.org/packages/ZXing.Net

### ThoughtWorks.QRCode
二维码处理库。
https://www.nuget.org/packages/ThoughtWorks.QRCode
...
https://www.nuget.org/packages/Spire.Barcode
